...
namespace HyparRunner
{
    ...
    public partial class FunctionDefinition
    {
        public static FunctionDefinition FromJson(string json) => JsonConvert.DeserializeObject<FunctionDefinition>(json, HyparRunner.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this FunctionDefinition self) => JsonConvert.SerializeObject(self, HyparRunner.Converter.Settings);
    }
